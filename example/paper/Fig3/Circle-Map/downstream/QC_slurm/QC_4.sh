...
#SBATCH -J QC_4
#SBATCH -o log/QC_4_%j.log
#SBATCH -e log/QC_4_%j.err
#SBATCH --time=1-00
#SBATCH -N 2 -n 80 
#SBATCH -p CPU-Small
...
python3 ecc_pipe_master.py --QC -n 80 --config /home/lifesci/liuk0617/workspace/ecc_pipe/ecc_pipe/config/QC/QC_4.yaml
