...
#SBATCH -J QC_6
#SBATCH -o log/QC_6_%j.log
#SBATCH -e log/QC_6_%j.err
#SBATCH --time=1-00
#SBATCH -N 2 -n 80 
#SBATCH -p CPU-Small
...
python3 ecc_pipe_master.py --QC -n 80 --config /home/lifesci/liuk0617/workspace/ecc_pipe/ecc_pipe/config/QC/QC_6.yaml
